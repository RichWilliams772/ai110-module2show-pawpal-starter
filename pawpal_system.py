...
class Scheduler:
    ...
    def load_tasks(self) -> None:
        """Pull all tasks from all of the owner's pets."""
    ...
    def detect_conflicts(self) -> List[str]:
        """Flag if total task duration exceeds owner's available time."""
        conflicts = []
    ...
    def generate_schedule(self) -> List[Task]:
        """
        Build a daily plan by fitting highest-priority tasks
